...
const Home: React.FC = () => {
  ...
  // 👉 useState for role and username to reactively redirect
  ...
  }, [role, username]); // 👈 watch these so logout triggers redirect
  ...
  const handleLogout = () => {
    ...
    if (confirmLogout) {
      ...
      // 🧠 Clear the state to trigger useEffect redirection
      setRole(null);
      setUsername(null);
    }
  };
